...
public class BaseAdapterUENextWeek extends BaseAdapter {
    ...
    public BaseAdapterUENextWeek(Context context, ArrayList<Integer> eventid, ArrayList<String> eventname, ArrayList<String> eventlocation, ArrayList<String> eventdatetime) {

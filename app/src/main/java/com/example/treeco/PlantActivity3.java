...
public class PlantActivity3 extends AppCompatActivity {
    Gallery gallery1;
    Button done, Share_social;
    TextView tagged, coins, treename;
    String points = "";
    String tree_name = "", LoginID = "", Plant_id_fetch = "";
    int action_type = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerViewAdapter recyclerViewAdapter=new RecyclerViewAdapter(getApplicationContext(),PlantActivity2.AddImagesGlobalPlant);
        ...
        postDataUsingVolley1(PlantActivity2.IDretriveAfterPlantingandTaging);
        mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.maps);

        client = LocationServices.getFusedLocationProviderClient(PlantActivity3.this);

        if (ActivityCompat.checkSelfPermission(PlantActivity3.this, Manifest.permission.ACCESS_FINE_LOCATION)
                == PackageManager.PERMISSION_GRANTED) {
            getCurrentLocation();
        } else {
            ActivityCompat.requestPermissions(PlantActivity3.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_CODE);
        }
        ;
    ...
    private void postDataUsingVolley1(String Logininfo) {
        ...
        String url = VariableDecClass.IPAddress + "apiPlantInfo";
        loadingPB.setVisibility(View.VISIBLE);

        // creating a new variable for our request queue
        RequestQueue queue = Volley.newRequestQueue(PlantActivity3.this);
        ...
        StringRequest request1 = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //Toast.makeText(PlantActivity3.this, "Fail to get response = " + error, Toast.LENGTH_SHORT).show();
                loadingPB.setVisibility(View.GONE);
    ...
    public void SharingToSocialMedia(String application, Bitmap bmpUri) {
    ...
    public void alertDialogPromt() {
        ...
        new MaterialAlertDialogBuilder(PlantActivity3.this, R.style.AlertDialogTheme)
                ...
                .setPositiveButton("ALLOW", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        content_container = (LinearLayout) PlantActivity3.this.findViewById(R.id.lv);
                        ...
                        img.setImageBitmap(PlantActivity2.AddImagesGlobalPlant.get(0));
                        //Toast.makeText(PlantActivity3.this, ""+PlantActivity2.AddImagesGlobalPlant.size(), Toast.LENGTH_SHORT).show();
                        ...
                        share.putExtra(Intent.EXTRA_TEXT, "http://www.google.com/maps/place/" + PlantActivity2.latvalplant + "," + TagActivity2.lngval + "/@" + TagActivity2.latval + "," + TagActivity2.lngval + ",17z");
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    // Toast.makeText(PlantActivity3.this, Statusretrive, Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        startActivity(new Intent(PlantActivity3.this, UserDashboard.class));
        // super.onBackPressed();
    }

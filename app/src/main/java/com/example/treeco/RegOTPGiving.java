...
public class RegOTPGiving extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reg_otpgiving);
        ...
        if (!(RegwithOTP.OTPvalfetched.equalsIgnoreCase("0") || RegwithOTP.OTPvalfetched.equalsIgnoreCase(""))) {
            String valfetched = RegwithOTP.OTPvalfetched;
            char chars[] = valfetched.toCharArray();
            //Toast.makeText(this, ""+valfetched, Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.resendtxt) {
            String MobileNumber = RegwithOTP.MobileNumber;
    ...
    private void postDataUsingVolley(String MobileNum) {
        ...
        RequestQueue queue = Volley.newRequestQueue(RegOTPGiving.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                //Toast.makeText(RegOTPGiving.this, "OTP Fetched", Toast.LENGTH_SHORT).show();
                try {
                    ...
                    if (OTPretrive.equalsIgnoreCase("0")) {
                        //Toast.makeText(RegOTPGiving.this, "" + Statusretrive, Toast.LENGTH_LONG).show();
                        edotp1.setText("");
                        edotp2.setText("");
                        edotp3.setText("");
                        edotp4.setText("");
                    } else {
                        //Toast.makeText(RegOTPGiving.this, "" + Statusretrive + ":OTP val:" + OTPretrive, Toast.LENGTH_LONG).show();
                        // RegwithOTP.OTPvalfetched = OTPretrive;
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                // Toast.makeText(RegOTPGiving.this, "Fail to get response = " + error, Toast.LENGTH_SHORT).show();
                loadingPB.setVisibility(View.GONE);
            }
        }) {
            @Override

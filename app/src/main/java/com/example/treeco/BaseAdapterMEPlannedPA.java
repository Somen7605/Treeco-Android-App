...
public class BaseAdapterMEPlannedPA extends BaseAdapter {
    ...
    public BaseAdapterMEPlannedPA(Context context, ArrayList<Integer> eventid, ArrayList<String> eventname, ArrayList<String> eventlocation, ArrayList<String> eventdatetime) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = inflater.inflate(R.layout.cardevent4, null);

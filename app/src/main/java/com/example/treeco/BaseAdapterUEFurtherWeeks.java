...
public class BaseAdapterUEFurtherWeeks extends BaseAdapter {
    ...
    public BaseAdapterUEFurtherWeeks(Context context, ArrayList<Integer> eventid, ArrayList<String> eventname, ArrayList<String> eventlocation, ArrayList<String> eventdatetime) {
